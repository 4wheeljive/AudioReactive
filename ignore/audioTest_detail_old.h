...
namespace audioTest {
	...
	void printSampleData(){
		...
		EVERY_N_MILLISECONDS(500) {
			...
			Serial.print("Volume: ");
			Serial.println(myAudio::smoothedAudioData->volume);
			Serial.print("VolumeRaw: ");
			Serial.println(myAudio::smoothedAudioData->volumeRaw);
			Serial.print("Peak: ");
			Serial.println(myAudio::smoothedAudioData->peak);
			Serial.print("Beat Detected: ");
			Serial.println(myAudio::smoothedAudioData->beatDetected);
			Serial.print("Dominant Frequency: ");
			Serial.println(myAudio::smoothedAudioData->dominantFrequency);
			Serial.print("Magnitude: ");
			Serial.println(myAudio::smoothedAudioData->magnitude);
			Serial.print("Volume: ");
			Serial.println(myAudio::smoothedAudioData->volume);
